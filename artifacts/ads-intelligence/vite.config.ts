...
const appRoutes = new Set(["api", "login", "signup", "admin", "creator", "tracking", "domains", "postbacks", "pricing", "checkout", "support", "traffic-manager", "trends", "google-trends", "dashboard", "campaigns", "keywords", "reports", "drcash", "src", "assets", "node_modules"]);
